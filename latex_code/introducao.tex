...
Este relatório detalha a metodologia de pré-processamento, a seleção de atributos e a subsequente implementação e ajuste de quatro modelos de classificação distintos:
...
Os modelos são avaliados usando validação cruzada (K-Fold Cross-Validation com k=5) e comparados com base nas métrica acurácia e a AUC de cada modelo. Para encontrar o melhor modelo de cada algorítmo, a técnica de grid-search também foi aplicada.